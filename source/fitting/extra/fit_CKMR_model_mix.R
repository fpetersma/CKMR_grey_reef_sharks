...
## 'GR_sims_mix.R'. The complete environment was saved in 
## 'data_for_testing_estimator.RData'.  
## 
...
load("data/data_for_testing_estimator.RData")
...
# save.image("data/df_sufficient_age_known.RData")
